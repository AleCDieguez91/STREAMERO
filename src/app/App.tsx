    ...
    },
    {
      ...
      options: [
        { text: "Entrenar a fondo", detail: "A darlo todo", successChance: 0.50,
          success: { followers: 10000, reputation: 5, message: "Noqueas a {RIVAL} en el primer Round. Alzas el cinto con orgullo" },
        ...
        { text: "Apenas entrenas", detail: "Total es todo show", successChance: 0.50,
          success: { followers: 8000, reputation: 3, message: "Ninguno de los 2 emboca una piña pero el público se caga de risa. Ganás por puntos." },
          failure: { followers: -1000, reputation: 1, message: "Te quedás sin aire al minuto de pelea, {RIVAL} no perdona y te noquea. Te boludean en twitter por semanas" } },
      ],
    },
  ],
